...
- delete
      ...
      cd;cd OnDemand-Configuration-with-Monaco;
      sed -i 's/app_env/'$Tag_app_$Tag_env'/g' Maintenance-Window/delete-ondemand-mw/delete.yaml;./monaco deploy -e=environments.yaml Maintenance-Window/delete-ondemand-mw;sed -i 's/'$Tag_app_$Tag_env'/app_env/g' Maintenance-Window/delete-ondemand-mw/delete.yaml
